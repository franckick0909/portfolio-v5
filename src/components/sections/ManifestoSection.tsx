...
export default function ManifestoSection() {
  ...
  useGSAP(
    () => {
      ...
      gsap.fromTo(".manifesto-title-part1", 
        { x: "100vw", opacity: 0 },
        { 
          x: 0, opacity: 1, duration: 1.5, ease: "power3.out",
          scrollTrigger: { trigger: ".manifesto-title-container", start: "top 80%", toggleActions: "play none none reverse" }
        }
      );
      gsap.fromTo(".manifesto-title-part2", 
        { x: "-100vw", opacity: 0 },
        { 
          x: 0, opacity: 1, duration: 1.5, ease: "power3.out",
          scrollTrigger: { trigger: ".manifesto-title-container", start: "top 80%", toggleActions: "play none none reverse" }
      ...
      const splitSubtitles = new SplitType(".anim-subtitle", { types: "chars" } as any);
      const splitTitles = new SplitType(".anim-title", { types: "lines" } as any);
      ...
      const slideTexts = [0, 1, 2, 3].map(idx => ({
        chars: splitSubtitles.chars?.filter(c => c.closest(`.slide-${idx}-content`)) || [],
        tLines: splitTitles.lines?.filter(l => l.closest(`.slide-${idx}-content`)) || [],
        dLines: splitDescs.lines?.filter(l => l.closest(`.slide-${idx}-content`)) || [],
      }));

      // Cacher tous les textes initialement
      gsap.set([splitSubtitles.chars, splitTitles.lines, splitDescs.lines], { yPercent: 120 });

      // Slide 0 anime indépendamment à l'entrée
      gsap.to([slideTexts[0].chars, slideTexts[0].tLines, slideTexts[0].dLines], {
        yPercent: 0,
        duration: 1.2,
        stagger: 0.05,
        ease: "power4.out",
      ...
      mm.add("(min-width: 768px)", () => {
        ...
        // SCÈNE 0
        tl.to(".s0-img-wrapper", { clipPath: "inset(0% 0% 0% 50%)", ease: "power2.inOut", duration: 1 }, "split0")
          .to(".s0-text-content", { x: "-25vw", ease: "power2.inOut", duration: 1 }, "split0")
          .to(".s0-overlay", { opacity: 0, duration: 0.8 }, "split0");

        // SCÈNE 1
        tl.fromTo(".s1-part-1", { clipPath: "inset(100% 0% 0% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe1")
          .fromTo(".s1-part-2", { clipPath: "inset(0% 0% 100% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe1")
          .fromTo(".s1-img", { scale: 1.2 }, { scale: 1, duration: 1, ease: "none" }, "wipe1")
          .to(slideTexts[1].chars, { yPercent: 0, stagger: 0.02, duration: 0.4, ease: "power2.out" }, "wipe1+=0.4")
          .to(slideTexts[1].tLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe1+=0.4")
          .to(slideTexts[1].dLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe1+=0.5");

        // SCÈNE 2
        tl.fromTo(".s2-part-1", { clipPath: "inset(0% 0% 100% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe2")
          .fromTo(".s2-part-2", { clipPath: "inset(100% 0% 0% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe2")
          .fromTo(".s2-img", { scale: 1.2 }, { scale: 1, duration: 1, ease: "none" }, "wipe2")
          .to(slideTexts[2].chars, { yPercent: 0, stagger: 0.02, duration: 0.4, ease: "power2.out" }, "wipe2+=0.4")
          .to(slideTexts[2].tLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe2+=0.4")
          .to(slideTexts[2].dLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe2+=0.5");

        // SCÈNE 3
        tl.fromTo(".s3-wrapper", { clipPath: "inset(0% 0% 0% 100%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe3")
          .fromTo(".s3-img", { scale: 1.2 }, { scale: 1, duration: 1, ease: "none" }, "wipe3")
          .to(slideTexts[3].chars, { yPercent: 0, stagger: 0.02, duration: 0.4, ease: "power2.out" }, "wipe3+=0.4")
          .to(slideTexts[3].tLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe3+=0.4")
          .to(slideTexts[3].dLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe3+=0.5");
      });
      ...
      mm.add("(max-width: 767px)", () => {
        ...
        tl.to(".s0-img-wrapper", { clipPath: "inset(0% 0% 50% 0%)", ease: "power2.inOut", duration: 1 }, "split0")
          .to(".s0-text-content", { y: "25vh", ease: "power2.inOut", duration: 1 }, "split0")
          .to(".s0-overlay", { opacity: 0, duration: 0.8 }, "split0");

        tl.fromTo(".s1-part-1", { clipPath: "inset(0% 100% 0% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe1")
          .fromTo(".s1-part-2", { clipPath: "inset(0% 0% 0% 100%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe1")
          .fromTo(".s1-img", { scale: 1.2 }, { scale: 1, duration: 1, ease: "none" }, "wipe1")
          .to(slideTexts[1].chars, { yPercent: 0, stagger: 0.02, duration: 0.4, ease: "power2.out" }, "wipe1+=0.4")
          .to(slideTexts[1].tLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe1+=0.4")
          .to(slideTexts[1].dLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe1+=0.5");

        tl.fromTo(".s2-part-1", { clipPath: "inset(0% 0% 0% 100%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe2")
          .fromTo(".s2-part-2", { clipPath: "inset(0% 100% 0% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe2")
          .fromTo(".s2-img", { scale: 1.2 }, { scale: 1, duration: 1, ease: "none" }, "wipe2")
          .to(slideTexts[2].chars, { yPercent: 0, stagger: 0.02, duration: 0.4, ease: "power2.out" }, "wipe2+=0.4")
          .to(slideTexts[2].tLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe2+=0.4")
          .to(slideTexts[2].dLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe2+=0.5");

        tl.fromTo(".s3-wrapper", { clipPath: "inset(100% 0% 0% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: 1, ease: "none" }, "wipe3")
          .fromTo(".s3-img", { scale: 1.2 }, { scale: 1, duration: 1, ease: "none" }, "wipe3")
          .to(slideTexts[3].chars, { yPercent: 0, stagger: 0.02, duration: 0.4, ease: "power2.out" }, "wipe3+=0.4")
          .to(slideTexts[3].tLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe3+=0.4")
          .to(slideTexts[3].dLines, { yPercent: 0, stagger: 0.05, duration: 0.6, ease: "power2.out" }, "wipe3+=0.5");
      ...
      if (outroQuote) {
        outroSplit = new SplitType(outroQuote as HTMLElement, { types: "lines, words" } as any);
  ...
  return (
    <section ref={container} className="relative w-full bg-background z-40 overflow-hidden">
      ...
      <section className="scrub-container relative w-full min-h-[90vh] py-24 md:py-32 flex items-center bg-background px-6 md:px-16 lg:px-24">
        <div className="w-full max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
          ...
          <div className="w-full lg:w-3/5">
            <h2 className="text-foreground/70 font-sans text-xs tracking-[0.3em] uppercase mb-8 md:mb-12">01 // L'Origine</h2>
            <p className="scrub-text text-[clamp(1.5rem,3.5vw,3.5rem)] font-serif leading-[1.15] text-foreground font-medium text-balance">
              J'ai grandi dans un environnement calme propice à la curiosité. Intrigué très tôt par la technologie, j'ai appris à coder en autodidacte avant de consolider mon expertise. Aujourd'hui, je crée des expériences web uniques qui allient performance absolue et esthétisme pointu.
            </p>
          </div>
      ...
      {/* ═══════════════════════════════════════════════════════════════════════════ */}
      <div ref={pinWrapperRef} className="hank-pin-wrapper h-screen w-full relative overflow-hidden bg-background text-foreground z-20 select-none">
        ...
        <div className="absolute inset-0 w-full h-full z-10 bg-[#0a0a0a]">
           ...
           <div className="slide-0-content absolute inset-0 w-full h-full flex flex-col items-center justify-center p-8 md:p-16 z-20 pointer-events-none">
               <div className="s0-text-content max-w-xl text-center md:text-left flex flex-col items-center md:items-start text-white">
                 <span className="anim-subtitle font-sans text-xs tracking-[0.3em] uppercase mb-4 opacity-70 block">01 // {colItems[0].subtitle}</span>
                 <h3 className="anim-title text-4xl md:text-6xl font-serif tracking-tight mb-4">{colItems[0].title}</h3>
                 <p className="anim-desc text-sm md:text-lg opacity-80">{colItems[0].desc}</p>
               </div>
           </div>
        </div>
        ...
        <div className="absolute inset-0 w-full h-full z-20 pointer-events-none flex flex-col md:flex-row">
           <div className="slide-1-content s1-part-1 absolute top-0 left-0 w-full h-1/2 md:w-1/2 md:h-full flex items-center justify-center p-8 md:p-16 bg-[#0a0a0a] text-white">
               <div className="max-w-xl text-center md:text-left flex flex-col items-center md:items-start">
                 <span className="anim-subtitle font-sans text-xs tracking-[0.3em] uppercase mb-4 opacity-50 block">02 // {colItems[1].subtitle}</span>
                 <h3 className="anim-title text-3xl md:text-5xl font-serif tracking-tight mb-4">{colItems[1].title}</h3>
                 <p className="anim-desc text-sm md:text-base opacity-80">{colItems[1].desc}</p>
               </div>
           </div>
        ...
        <div className="absolute inset-0 w-full h-full z-30 pointer-events-none flex flex-col md:flex-row">
           <div className="slide-2-content s2-part-1 absolute top-0 left-0 w-full h-1/2 md:w-1/2 md:h-full flex items-center justify-center p-8 md:p-16 bg-background text-foreground">
               <div className="max-w-xl text-center md:text-left flex flex-col items-center md:items-start">
                 <span className="anim-subtitle font-sans text-xs tracking-[0.3em] uppercase mb-4 opacity-50 block">03 // {colItems[2].subtitle}</span>
                 <h3 className="anim-title text-3xl md:text-5xl font-serif tracking-tight mb-4">{colItems[2].title}</h3>
                 <p className="anim-desc text-sm md:text-base opacity-80">{colItems[2].desc}</p>
               </div>
           </div>
        ...
        <div className="slide-3-content s3-wrapper absolute inset-0 w-full h-full z-40 pointer-events-none bg-[#0a0a0a] text-white flex items-center justify-center">
            ...
            <div className="relative z-10 max-w-4xl text-center p-8">
               <span className="anim-subtitle font-sans text-xs tracking-[0.3em] uppercase mb-6 block opacity-70">04 // {colItems[3].subtitle}</span>
               <h3 className="anim-title text-[clamp(2.5rem,5vw,6rem)] font-serif tracking-tight mb-6">{colItems[3].title}</h3>
               <p className="anim-desc text-base md:text-xl opacity-90 leading-relaxed">{colItems[3].desc}</p>
            </div>
        </div>
      ...
      <section className="outro-section relative w-full h-screen flex items-center justify-center overflow-hidden bg-black text-white">
        ...
        <blockquote className="relative z-20 max-w-6xl text-center px-6 md:px-12 flex flex-col items-center mix-blend-screen">
          <span className="text-white/40 font-sans text-xs tracking-[0.4em] uppercase mb-8">03 // L'Ambition</span>
